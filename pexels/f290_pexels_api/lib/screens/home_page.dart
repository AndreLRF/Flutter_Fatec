...
class _HomePageState extends State<HomePage> {
  ...
  static const String API_KEY = '563492ad6f91700001000001904301133c3346d9b8fcb520d039837c';

  Future _getImages() async {
   
    final urlCuratedPhotos = 'https://api.pexels.com/v1/curated?per_page=40&page=1'; 
    final urlSearch = 'https://api.pexels.com/v1/search?query=$_busca&per_page=40&page=1';
